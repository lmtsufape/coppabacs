              ...
              {listSementes.map((sementes) => {
                return sementes.tabelaBancoSementes.map((tabelaBancoSementes, index) => {
                  return (
                    <tr key={index}>
                      <td data-label="Imagem"><Image src="/assets/sementeteste.png" alt="Foto do usuário" width={50} height={50} /></td>
                      <td data-label="Nome">{sementes.nome}</td>
                      {/**
                   * 
                   <td>{sementes.cultura.cultura}</td>
                   <td>{tabelaBancoSementes.peso}</td>
                  */}
                      <td data-label="Safra">{tabelaBancoSementes.safra}</td>
                      <td className={styles.content__table__buttonTabela}>
                        <div className={styles.content__table__button}>
                          <h1>Visualizar</h1>
                          <Image className={styles.content__table__button_img} src="/assets/iconOlho.svg" alt="Visualizar" onClick={() => onSelectTabela(tabelaBancoSementes, sementes.nome, sementes.cultura.cultura)} width={27} height={26} />
                          {/*<ExcluirButton itemId={sementes.id} onDelete={handleDeleteSementes} />
                          */}
                        </div>
                      </td>
                ...
                return sementes.tabelaBancoSementes.map((tabelaBancoSementes, index) => {
                  ...
                  */}
                      ...
                      <td className={styles.content__table__buttonTabela}>
                        <div className={styles.content__table__button}>
                          <h1>Visualizar</h1>
                          <Image className={styles.content__table__button_img} src="/assets/iconOlhoBranco.png" alt="Visualizar" onClick={() => onSelectTabela(tabelaBancoSementes, sementes.nome, sementes.cultura.cultura)} width={27} height={26} />
                        </div>
                      </td>
                    </tr>
                  );
